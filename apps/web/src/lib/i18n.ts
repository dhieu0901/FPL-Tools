...
const messages = {
  ...
  "squad.colPlayer": "Player",
  "squad.colOpponent": "Opponent",
  "squad.colStatus": "Status",
  "squad.colPoints": "Pts",
  "squad.home": "H",
  "squad.away": "A",
  "squad.statusDone": "Done ({minutes}')",
  "squad.statusLive": "Live {minutes}'",
  "squad.statusUnscheduled": "Not scheduled",
  "squad.noFixture": "No match",
